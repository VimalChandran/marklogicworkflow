...
(: TODO createSubprocess OR alter above to optionally include parent process id and other properties :)
...
(: TODO check eval functions for XQuery injection attacks :)
